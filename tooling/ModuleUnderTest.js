...
import moduleFromBundle    from '../dist/feature-redux';
import moduleFromBundleMin from '../dist/feature-redux.min';
...
switch (MODULE_PLATFORM) {
  ...
  case undefined:
    ...
    break;
  case 'bundle':  
    console.log(`*** Testing Module Platform found in: dist/feature-redux (MODULE_PLATFORM: ${MODULE_PLATFORM})`);
    moduleUnderTest = moduleFromBundle;
    break;
  case 'bundle.min':  
    console.log(`*** Testing Module Platform found in: dist/feature-redux.min (MODULE_PLATFORM: ${MODULE_PLATFORM})`);
